...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full bg-white/30 backdrop-blur-lg z-50 h-16">
              ...
              {isLegalsOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg z-50">
                  <div className="py-1">
                    ...
                    {/* <Link href="/legals/shipping-delivery" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Shipping & Delivery
                    </Link> */}
                    <Link href="/legals/cancellation-refund" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Cancellation & Refund
                    </Link>
                    {/* <Link href="/legals/cookies" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Cookies
                    </Link> */}
                  </div>
                </div>
            ...
            <div className="border-t border-gray-200 pt-2">
              ...
              {isLegalsOpen && (
                <div className="pl-4 space-y-1">
                  ...
                  {/* <Link href="/legals/shipping-delivery" className="block px-3 py-2 text-sm text-gray-700">
                    Shipping & Delivery
                  </Link> */}
                  <Link href="/legals/cancellation-refund" className="block px-3 py-2 text-sm text-gray-700">
                    Cancellation & Refund
                  </Link>
                  {/* <Link href="/legals/cookies" className="block px-3 py-2 text-sm text-gray-700">
                    Cookies
                  </Link> */}
                </div>
              )}
